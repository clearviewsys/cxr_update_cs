...
Case of 
	: ([Customers:3]isCompany:41=False:C215)  // Conductor is a Person
		...
		If (False:C215)
			...
			$fromForeignCurrency:=GAML_CreateXMLNode($t_conductor; "from_foreign_currency")
...
If ([Customers:3]isCompany:41=False:C215)
	$to_person:=GAML_CreateXMLNode($t_to; "to_person")
	GAML_NodeT_PersonFromCustomer($to_person)
Else 
	$to_entity:=GAML_CreateXMLNode($t_to; "to_entity")
	GAML_NodeT_PersonFromCustomer($to_entity)
End if 
