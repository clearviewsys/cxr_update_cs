	...
	Case of 
		...
		: (Trigger event:C369=On Saving New Record Event:K3:1)
			...
			Else 
				...
				setDateTimeUser(->[Registers:10]CreationDate:14; ->[Registers:10]CreationTime:15; ->[Registers:10]CreatedByUserID:16)
		...
		: (Trigger event:C369=On Saving Existing Record Event:K3:2)
			...
			Else 
				If (Sync_IsSyncProcess)  //don't update anything coming from sync take as is
				Else 
					setDateTimeUser(->[Registers:10]ModificationDate:20; ->[Registers:10]ModificationTime:21; ->[Registers:10]ModifiedByUserID:22)
					RegistersTriggerHelper
		...
		: (Trigger event:C369=On Deleting Record Event:K3:3)
			...
			If ([Registers:10]isValidated:35)  //added by TB; we don't want reconciled records to be deleted
...
AUDIT_Trigger
//If (getKeyValue("debug.syncid"; "false")="true")
//TriggerSync(True)
//Else 
//TriggerSync  // previously sync_trigger 
//End if 
