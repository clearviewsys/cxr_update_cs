...
cs:C1710.SanctionListsEntity; $optionsParam : Object)
...
If (Not:C34(isLicenseRecordExpired("KYC2020")))
	...
	If ($options.data.birthday#!00-00-00!)
		$content.Date:=$options.data.birthday
	End if 
	...
	Case of 
		: (($statusCode=0) | Not:C34(OB Is defined:C1231($response; "status")))
