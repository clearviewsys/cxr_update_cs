...
//@Beneficiary ID (String) Id of beneficiary ot be updated
//@Beneficiary (Object): Contains all fields for beneficiary
//@Auth (String): Either authKey or email and apiKey
//
//
//Outputs:
//On Success: Beneficiary ID (String)
//On Failure: Status code of error, error message -> @Error
//**************************************************************

C_TEXT:C284($0; $2; $4; $5; $URL; $benId; $authKey)
C_OBJECT:C1216($3; $beneficiary)
C_LONGINT:C283($status; $i)
C_BOOLEAN:C305($correct)
C_POINTER:C301($pError; $1; $pHeaderNames; $pHeaderValues; $pHeaderNames)
...
If (Length:C16($authKey)>3)
	...
	$status:=HTTP Request:C1158(HTTP POST method:K71:2; \
		$URL+"/beneficiaries/"+$benId; \
		$body; $response; $headerNames; $headerValues)
	
	CC_createLogRecord("POST beneficiaries/"+$benId; $body; String:C10($status); $response)
