...
C_BOOLEAN:C305($5; $bAllDay)  //is this an all day event
C_LONGINT:C283($6; $iRepeatDays)  //how often to repeat this in days
C_TEXT:C284($7; $tNotes)  //any notes about the task - optional
C_TEXT:C284($8; $tCalendarName)  //calendar name for "grouping" - optional
...
[CalendarEvents:80]isTask:7:=False:C215
...
[CalendarEvents:80]isAllDayEvent:3:=$bAllDay
