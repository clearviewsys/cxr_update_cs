								...
								For each ($email; $col) While ($error=0)
									...
									Case of 
										: ($entity.message.message="@CID:embedded@") & ($entity.message.attachments#Null:C1517)  // with content id referring to the embedded image
											$error:=sendEmailviaSMTP(Lowercase:C14($email); $entity.message.subject; $entity.message.message; $entity.message.attachments)
										: ($entity.message.attachments#Null:C1517)
											$error:=sendEmailUsingServerSettings(Lowercase:C14($email); $entity.message.subject; $entity.message.message; $entity.message.attachments)
										Else 
											$error:=sendEmailUsingServerSettings(Lowercase:C14($email); $entity.message.subject; $entity.message.message)
									End case 
