...
//author: Amir
//5th Sept 2018
// getSubAccountBalanceInDateRange (subaccountID; fromDate ; toDate; ->openingBalance;->transferIn;->transferOut; ->sumDebit;->sumCredit; ->balance; ->sumCreditLocal; ->$sumDebitLocal; ->$sumFees; $branchID)
...
QUERY:C277([Registers:10]; [Registers:10]SubAccountID:58=$subaccountID)
