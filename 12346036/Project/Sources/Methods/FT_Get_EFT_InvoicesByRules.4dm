//%attributes = {}
// FT_Get_EFT_InvoicesByRules ($dateref;->$invoicesPtr;->$invoices24hIndPtr)
...
QUERY:C277([Invoices:5];  & ; [Invoices:5]isEFT:77=True:C214)
...
//SORT ARRAY($invoicesPtr->;$invoices24hIndPtr->)
