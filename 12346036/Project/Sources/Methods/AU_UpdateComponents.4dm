//%attributes = {}
// AU_UpdateComponents
// run update process for only Components Folder
...
If (Num:C11($auEnabled)=1)
	...
	Else 
		AU_DoUpdate(False:C215; True:C214; False:C215; False:C215)  // Structure, Components, Resources, Plugins
	End if 
	
	$0:="Component Update Started"
