...
C_TEXT:C284($14)  // Attempted transaction  indicator

C_BLOB:C604($content)
C_TEXT:C284($repSeqNum)
C_TEXT:C284($partID; $repEntityRefNum; $actionCode)
C_TEXT:C284($contactPhoneNumberExt; $entityType)
C_TEXT:C284($repEntityIdNum; $contactSurName; $repEntityLocNum; $contactGivenName; $contactOtherName; $contactPhoneNumber; $txIndicator)
...
$repEntityIdNum:=FT_StringFormat($6; 7; "0"; "LJ")
...
$txIndicator:=$14
TEXT TO BLOB:C554($txIndicator; $content; UTF8 text without length:K22:17; *)
