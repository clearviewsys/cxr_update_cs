//%attributes = {}
// AU_UpdateResources
// run update process for only Resources Folder
...
If (Num:C11($auEnabled)=1)
	...
	Else 
		AU_DoUpdate(False:C215; False:C215; True:C214; False:C215)  // Structure, Components, Resources, Plugins
	End if 
	
	$0:="Resouces Update Started"
