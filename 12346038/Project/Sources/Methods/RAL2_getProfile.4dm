//%attributes = {}
//Method for Getting the profile of an account from the RAL server
//Parameters: Client Code (string), Client Key (string)

//Parameters
C_TEXT:C284($1; $code; $2; $key)
C_OBJECT:C1216($0)
//Internal
...
$requestUrl:="https://cloud.clearviewsys.net/ral/json/getProfile?"+$params
