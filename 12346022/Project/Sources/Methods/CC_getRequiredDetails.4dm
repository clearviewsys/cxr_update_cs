...
//**************************************************************
//Method for getting the required details to create a beneficiary
//
//Required Parameters:
...
//@Beneficiary Country(String): 2 letter ISO code of country or the beneficiary
//@Auth (String): Either authKey or email and apiKey
//
//Outputs:
//On Success: Object containing arrays of required information
//On Failure: Object containing error code, error message -> @Error
//**************************************************************

C_OBJECT:C1216($0)
C_TEXT:C284($URL; $authKey; $body; $query; $response; $currency; $bankCountry; $beneficiaryCountry; $authKey; $email; $apiKey; $2; $3; $4; $5; $6)
...
If (Length:C16($authKey)>3)
	...
	$query:=$query+"&bank_account_country="+$bankCountry
	$query:=$query+"&beneficiary_country="+$beneficiaryCountry
	...
	$status:=HTTP Request:C1158(HTTP GET method:K71:1; \
		$URL+"/reference/beneficiary_required_details?"+$query; \
