...
arrAccountIDs{$row}:=makeCashAccountID($currency)
...
calcCashPositionsForCurrency($currency; $p2; $p3; $p4; $p5; $p6; $p7; $p8; $p9; $p10; $p11)
selectCurrencyByISOCode($currency)
arrMarketValues{$row}:=[Currencies:6]SpotRateLocal:17*arrBalances{$row}
