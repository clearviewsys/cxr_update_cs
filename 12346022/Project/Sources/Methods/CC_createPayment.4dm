...
//
//Outputs:
//On Success: Payment Object
//On Failure: Object containing status code of error, error message -> @Error
//**************************************************************

C_TEXT:C284($URL; $authKey; $3; $4)
C_OBJECT:C1216($0; $2; $payment)
...
If (Length:C16($authKey)>3)
	...
	If ($correct)
		...
		$status:=HTTP Request:C1158(HTTP POST method:K71:2; $URL+"/payments/create"; $body; $response; $headerNames; $headerValues)
		...
		Else 
			$0:=New object:C1471("Error"; $status)
	...
	Else 
		...
		$0:=New object:C1471("Error"; "400")
	End if 
Else 
	//Error Loggin in
	//Error pointer srt within the Login function
	$0:=New object:C1471("Error"; $authKey)
End if 