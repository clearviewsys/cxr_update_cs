...
Case of 
	...
	: ((Form event code:C388=On Data Change:K2:15) | (Form event code:C388=On Clicked:K2:4) | (Form event code:C388=On Outside Call:K2:11))
		...
		//setVisibleIff([Invoices]isAMLReportable; "Reportable")
		setVisibleIff([Invoices:5]isSuspicious:30; "STRisReport@")
		...
		//setVisibleIff($isBalanced & $condition; "b_save" // 5/10/22 ibb reverted to old method b/c can't save emptyp invoice
		setVisibleIff($isBalanced; "b_save")
