//%attributes = {}
// FJ_QueryRegisters_CTR (customerID;fromdate; toDate): returns the sum of debitLC
...
//SET FIELD RELATION([Registers]AccountID;Automatic;Manual)  // for JOIN
//QUERY SELECTION BY FORMULA([Registers];[Accounts]isCashAccount=True)  // JOIN: cash only transactions (dynamic search)
