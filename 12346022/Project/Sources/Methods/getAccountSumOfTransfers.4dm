//%attributes = {}
//getAccountSumOfTransfers(accountID;{fromDate;toDate;applyDateRange};branchID) -> real:balance
...
QUERY SELECTION:C341([Registers:10]; [Registers:10]isTransfer:3=True:C214)  // non-transfer only
...
$result:=Sum:C1([Registers:10]Debit:8)-Sum:C1([Registers:10]Credit:7)  // doesn't need to round
