...
If (OK=1)
	...
	For ($i; 1; $iColCount)
		...
		QR SET TEXT PROPERTY:C759($iArea; $i; qr title:K14906:1; qr font name:K14904:10; "Arial")
		...
		QR SET TEXT PROPERTY:C759($iArea; $i; qr grand total:K14906:3; qr font name:K14904:10; "Arial")  // added by @tiran for compatibility with v18
		...
		QR SET TEXT PROPERTY:C759($iArea; $i; qr detail:K14906:2; qr font name:K14904:10; "Arial")  // added by @tiran 
	...
	QR SET TEXT PROPERTY:C759($iArea; 1; qr header:K14906:4; qr font name:K14904:10; "Arial")  // @tiran
	...
	QR SET TEXT PROPERTY:C759($iArea; 1; qr footer:K14906:5; qr font name:K14904:10; "Arial")  // added by @tiran 
	...
	Else 
		...
		// CXR7 is running under v18 where the bug ACI0100567 is fixed, so there is no need for this workaround
		
		//C_TEXT($template)
		//$template:=QR Get HTML template($iArea)
		//$template:=Replace string($template;"\n";"")
		//QR SET HTML TEMPLATE($iArea;$template)
	...
	//If ($iDestination=qr HTML file)
	//If (Test path name($tFilePath)=Is a document)
	//C_TEXT($htmlDoc)
	//$htmlDoc:=Document to text($tFilePath;"UTF-8")
	//$htmlDoc:=Replace string($htmlDoc;"<br>";"")
	//TEXT TO DOCUMENT($tFilePath;$htmlDoc;"UTF-8")
	//End if 
	//End if 
