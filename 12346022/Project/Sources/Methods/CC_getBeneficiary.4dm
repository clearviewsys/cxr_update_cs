...
//**************************************************************
//Method for Finding a Beneficiary on the Currency Cloud Platform
//
//Required Parameters:
//@Error (Pointer): Pointer to text variable
//@Beneficiary ID (String): UUID of beneficiary
//@Auth (String): Either authKey or email and apiKey
//
//Outputs:
//On Success: Object containing beneficiary information
//On Failure: Object containing error code, error message -> @Error
//**************************************************************

C_OBJECT:C1216($0)
C_TEXT:C284($URL; $benId; $authKey; $body; $response; $2; $3; $4)
...
If (Length:C16($authKey)>3)
	...
	CC_createLogRecord("GET beneficiaries/"; $body; String:C10($status); $response)
