...
Case of 
	...
	: (Form event code:C388=On End URL Loading:K2:47)
		...
		Case of 
			...
			: ($url=Form:C1466.deniedURL)
				
				C_OBJECT:C1216($updateObj)
				
				$updateObj:=New object:C1471
				
				$updateObj.receiptHTML:=WA Get page content:C1038(*; Form:C1466.mywa)
				Form:C1466.receiptHTML:=$updateObj.receiptHTML
				
				If (mgUpdateWebewire(Form:C1466.WebewireID; $updateObj))
					IDLE:C311
				End if 
