...
$msg:=$msg+"this means a real environment, in order to submit the report using the AUSTRAC Platform."+Char:C90(CR ASCII code:K15:14)+Char:C90(CR ASCII code:K15:14)
