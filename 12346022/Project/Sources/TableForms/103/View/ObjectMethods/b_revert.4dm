...
myConfirm("Are you sure you want to revert the source code to revision "+String:C10(arrIDs{arrIDs}); "Replace Method"; "Cancel")
If (OK=1)
	METHOD SET CODE:C1194([DB_CodeRevisions:103]MethodPath:12; vSourceCode)
	// commit4DMethod
