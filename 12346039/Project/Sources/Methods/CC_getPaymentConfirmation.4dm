...
//
//Outputs:
//On Success: Object containing confirmation information
...
If (Length:C16($authKey)>3)
	...
	$status:=HTTP Request:C1158(HTTP GET method:K71:1; \
		$URL+"/payments/"+$payId+"/confirmation"; \
		$body; $response; $headerNames; $headerValues)
	
	CC_createLogRecord("GET payments/"+$payId+"/confirmation"; ""; String:C10($status); $response)
