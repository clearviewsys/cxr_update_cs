...
If ($continue)
	...
	COLLECTION TO ARRAY:C1562($matches; $array)
	C_LONGINT:C283($list)
	$list:=New list:C375
	ARRAY TO LIST:C287($array; $list)
	OBJECT SET LIST BY REFERENCE:C1266($selfPtr->; $list)
