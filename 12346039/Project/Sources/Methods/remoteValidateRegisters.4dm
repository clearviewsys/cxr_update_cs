...
Else 
	...
	//Sync_Validation_resyncTable ($tRemoteSite;$tRemoteURL;$tSourceSite;$tRemotePassword;Table(->[Registers]);!1970-01-01!;Current date)
	$status:=Sync_validateTable(Table:C252(->[Registers:10]); $param)
End if 
