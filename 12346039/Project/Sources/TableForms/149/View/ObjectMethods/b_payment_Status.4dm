...
Case of 
	...
	Else 
		//If (Current user="designer")
		Case of 
			: ([WebEWires:149]paymentInfo:35.gateway=Null:C1517)
				// do nothing
			: ([WebEWires:149]paymentInfo:35.gateway="paymark")
				If ([WebEWires:149]paymentInfo:35.url#"")
					...
					Case of 
						: ([WebEWires:149]paymentInfo:35.transactionRefNo=Null:C1517)
						...
						: (OB Get:C1224([WebEWires:149]paymentInfo:35; "transactionRefNo"; Is text:K8:3)="")
							$return:=PMARK_searchTransaction(New object:C1471("reference"; [WebEWires:149]WebEwireID:1; "startDate"; [WebEWires:149]creationDate:15; "endDate"; [WebEWires:149]creationDate:15+1))
							If ($return.response.length>0)
								$response:=$return.response[0]
							End if 
						...
						Else 
							$return:=PMARK_getTransaction(OB Get:C1224([WebEWires:149]paymentInfo:35; "transactionRefNo"; Is text:K8:3))
					...
					If ($return.success) & ($status#"")
						...
						If (OK=1)
							...
							//[WebEWires]paymentInfo.status:=$response.status  //same as above
