Case of 
	...
	: (Form event code:C388=On Load:K2:1)
		...
		APPEND TO ARRAY:C911(cboReportTypeFT; "LCT(Large Cash Transactions)")
		APPEND TO ARRAY:C911(cboReportTypeFT; "EFTI(eWires Incoming-Non-Swift)")
		APPEND TO ARRAY:C911(cboReportTypeFT; "EFTO(eWires Outgoing-Non-Swift)")
		APPEND TO ARRAY:C911(cboReportTypeFT; "EFTO(Wires Non-Swift)")
		APPEND TO ARRAY:C911(cboReportTypeFT; "STR(Suspicious Transactions)")
		APPEND TO ARRAY:C911(cboReportTypeFT; "Generated File")
		cboReportTypeFT:=1
