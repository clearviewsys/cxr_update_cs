...
$thresholdForPTRTransfers:=0

queryIFTO($fromDate; $toDate; True:C214)
CREATE SET:C116([eWires:13]; "$ifto")
queryIFTI($fromDate; $toDate; True:C214)
...
//While (Not(End selection([eWires])))
//APPEND TO ARRAY(arrALLEFT;[eWires]eWireID)
//NEXT RECORD([eWires])
//End while 
