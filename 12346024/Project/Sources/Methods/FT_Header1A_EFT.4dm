...
C_LONGINT:C283($subHederSeq; $numRepxSubhdr)
...
C_TEXT:C284($batchTime; $batchType; $subHeaderCnt; $formatIndicator; $opMode; $repEntityIdNum; $batchDate; $batchSeqId)
C_TEXT:C284($reportCnt)
C_BLOB:C604($content)
// Record type
...
// PKI certificate ID
$pkiCertificateId:=FT_StringFormat($10; 10; "0"; "LJ")
...
TEXT TO BLOB:C554($subHeaderCnt; $content; UTF8 text without length:K22:17; *)

// Report count
$reportCnt:=FT_NumberFormat($16; 0; 5; "0"; "RJ")
TEXT TO BLOB:C554($reportCnt; $content; UTF8 text without length:K22:17; *)
