...
If (Shift down:C543)
	$cropValue:=Int:C8($iWidth*0.1)  // by crop by 3 percent
Else 
	$cropValue:=Int:C8($iWidth*0.03)  // by crop by 3 percent
End if 

C_PICTURE:C286(vPreviousPicture)
vPreviousPicture:=$picturePtr->

TRANSFORM PICTURE:C988($picturePtr->; Crop:K61:7; $cropValue; 0; $iWidth-$cropValue; $iHeight)  //scale to 
