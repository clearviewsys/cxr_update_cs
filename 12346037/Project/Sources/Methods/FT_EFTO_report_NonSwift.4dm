//%attributes = {}
// ------------------------------------------------------------------------------
// Method: FT_EFTO_report_NonSwift //TODELETE
...
FT_Get_EFT_Transactions_NS(initialDate; initialDate; True:C214)
...
If (Records in selection:C76([Wires:8])=0)
	$msg:="There are not transactions that can be reported as Wires EFTO - Non Swift in the date requested"
