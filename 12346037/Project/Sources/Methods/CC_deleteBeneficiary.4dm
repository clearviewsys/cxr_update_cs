...
//@Beneficiary ID(String): ID of beneficiary to be deleted
...
C_TEXT:C284($URL; $benId; $authKey; $body; $response; $0; $2; $3; $4; $ret)
...
If (Length:C16($authKey)>3)
	...
	$status:=HTTP Request:C1158(HTTP POST method:K71:2; \
		$URL+"/beneficiaries/"+$benId+"/delete"; \
		$body; $response; $headerNames; $headerValues)
	
	CC_createLogRecord("POST beneficiaries/delete"; $body; String:C10($status); $response)
