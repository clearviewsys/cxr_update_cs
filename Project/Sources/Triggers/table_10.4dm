		...
		: (Trigger event:C369=On Deleting Record Event:K3:3)
			...
			Case of 
				: (Current user:C182="designer")  //8/25/22 need a backdoor option @ibb
					...
					UTIL_Log("registers"; "DEL\t"+UTIL_recordToText(Table:C252(->[Registers:10]); Char:C90(Tab:K15:37)))
