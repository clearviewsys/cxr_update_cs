...
//QUERY([Registers];[Registers]externalTableNumber=Table(->[CashTransactions]);*)
//QUERY([Registers]; & ;[Registers]Currency=$currency)
...
CREATE SET:C116([Registers:10]; "$BankTransactions")
...
CLEAR SET:C117("$BankTransactions")
