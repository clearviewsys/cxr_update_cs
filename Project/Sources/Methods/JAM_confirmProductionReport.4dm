...
$msg:=$msg+"this means a real environment, in order to submit the report to the accounting system. "+Char:C90(CR ASCII code:K15:14)+Char:C90(CR ASCII code:K15:14)
