...
// Jan 2021
C_OBJECT:C1216($test)
$test:=AJ_UnitTest.new("validateIBAN_UsingJSON"; Current method name:C684; "API.validateIBAN")
...
validateIBAN($IBAN; ->$errCode; ->$bankName; ->$countryCode; ->$city; ->$address; ->$BIC; ->$validCheckSum)
$expected:=""
