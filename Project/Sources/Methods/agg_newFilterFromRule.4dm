...
$filterObj.purposeOfTransactions:=$ruleObj.ifObj.purposeOfTransactions
$filterObj.sourceOfFunds:=$ruleObj.ifObj.sourceOfFunds
$filterObj.typeOfTransactions:=$ruleObj.ifObj.typeOfTransactions
$filterObj.events:=$ruleObj.whenObj.events
