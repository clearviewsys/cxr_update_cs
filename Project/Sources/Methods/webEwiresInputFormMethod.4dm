...
Case of 
	: ((Form event code:C388=On Load:K2:1) | (Form event code:C388=On Outside Call:K2:11))
		...
		Case of 
			: ($isProfix)  // dont do anything - internal MG not webbased
				OBJECT SET VISIBLE:C603(*; "b_@"; False:C215)
				...
				OBJECT SET VISIBLE:C603(*; "b_invoice@"; True:C214)
