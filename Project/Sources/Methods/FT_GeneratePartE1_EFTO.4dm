...
C_BLOB:C604($content)
C_TEXT:C284($companyName; $surnameAndOthers; $streetAddress; $city; $country; $state; $zipCode; $surname; $name)
...
// Part ID
//$tmp1:="E1"
TEXT TO BLOB:C554($txType; $content; UTF8 text without length:K22:17; *)
...
Else 
	...
	// Country
	//$country:=FT_StringFormat ([CompanyInfo]CountryCode;2)
	$country:=FT_StringFormat([CompanyInfo:7]CountryCode:28; 2)
	TEXT TO BLOB:C554($country; $content; UTF8 text without length:K22:17; *)
