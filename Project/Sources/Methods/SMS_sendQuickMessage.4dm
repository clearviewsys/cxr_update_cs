...
$pass:=<>clickatellPassword
$apiID:=<>clickatellSOAP_API_ID  // not sure
$from:=<>clickatellPhone
...
$escalate:=0
$mo:=0  // should be off
$smsID:="SMS1002"  // automatically generated by the system
...
myAlert("Response: "+($responsePtr->{1}))