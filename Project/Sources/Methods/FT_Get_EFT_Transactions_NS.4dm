...
C_BOOLEAN:C305($3; $isOutgoing)  //true: Outgoing false: Incoming
...
Case of 
	...
	: ($queryType="0")  // By Default: Do not use the AML Agr Rules
		...
		FT_Set24HoursIndicatorEFT_NS($toDate; ->$arrRecords; ->arr24HoursIndicator; reportBranchId; $isOutgoing)
	...
	: ($queryType="1")  // By Default: Do not use the AML Agr Rules
		...
		QUERY SELECTION:C341([Wires:8]; [Wires:8]isOutgoingWire:16=$isOutgoing)
