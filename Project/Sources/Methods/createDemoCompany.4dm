//%attributes = {}
// createDemoCompany
// this Method creates a default company record if this record doesn't already exist
// 
...
If (Records in selection:C76([CompanyInfo:7])=0)
	...
	[CompanyInfo:7]Country:10:="Canada"
	[CompanyInfo:7]CountryCode:28:="CA"
	[CompanyInfo:7]Currency:11:="CAD"
	[CompanyInfo:7]ClientCode:15:=""
	[CompanyInfo:7]ClientKey:16:=""
	[CompanyInfo:7]ClientCode2:25:=""
	[CompanyInfo:7]ClientKey2:26:=""
	[CompanyInfo:7]HighestVersionAllowed:24:="7.999"
	...
	//openFormWindow(->[CompanyInfo]; "CompanyInfo")
	//MODIFY RECORD([CompanyInfo]; *)
