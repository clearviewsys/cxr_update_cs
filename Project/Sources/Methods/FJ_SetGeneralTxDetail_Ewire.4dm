...
End if 
If ([eWires:13]eWireID:1="TSEWI25105")
	//TRACE
End if 
...
If ([eWires:13]isPaymentSent:20)  // outgoing eWires
	...
	Else 
		$rptInfo:=$rptInfo+FJ_AddTagToReport(":C05:"; FJ_MaxString([eWires:13]fromCountry:9; 35); True:C214)
	End if 
...
Else   // incoming eWires
	...
	Else 
		If ([Branches:70]City:4#"")
			$rptInfo:=$rptInfo+FJ_AddTagToReport(":C05:"; FJ_MaxString([Branches:70]City:4; 35); True:C214)  // City of the sender Branch 
		Else 
			$rptInfo:=$rptInfo+FJ_AddTagToReport(":C05:"; FJ_MaxString([eWires:13]fromCountry:9; 35); True:C214)  // City of the sender Branch 
		End if 
	...
	If ([Branches:70]City:4#"")
		$rptInfo:=$rptInfo+FJ_AddTagToReport(":C09:"; FJ_MaxString([Branches:70]City:4; 35); True:C214)  // City of the sender Branch 
	Else 
		$rptInfo:=$rptInfo+FJ_AddTagToReport(":C09:"; FJ_MaxString([eWires:13]toCountry:10; 35); True:C214)  // City of the sender Branch 
	End if 
	
	//$rptInfo:=$rptInfo+FJ_AddTagToReport (":C09:";FJ_MaxString ([Branches]City;35);True)
...
Else 
	...
	If (False:C215)
		...
		$address:=FJ_ContactAddress([eWires:13]senderAddress:96; [eWires:13]senderCity:98; [eWires:13]senderState:99; [eWires:13]senderPostalCode:100; [eWires:13]fromCountryCode:111)
		$rptInfo:=$rptInfo+FJ_AddTagToReport(":F02:"; FJ_MaxString([eWires:13]SenderName:7+" "+$address; 35; 4); False:C215)
...
If ([eWires:13]isPaymentSent:20)  // Outgoing eWire  
	...
	If ([eWires:13]isBeneficiaryCompany:93)
		...
		$rptInfo:=$rptInfo+FJ_AddTagToReport(":L04:"; FJ_MaxString([eWires:13]BeneficiaryFullName:5; 70); True:C214)
...
Else 
	...
	If ([Customers:3]isCompany:41)
		...
		$address:=FJ_ContactAddress([Customers:3]Address:7; [Customers:3]City:8; [Customers:3]Province:9; [Customers:3]PostalCode:10; [Customers:3]CountryCode:113)
		If ([eWires:13]BeneficiaryCompanyName:92#"")
			$rptInfo:=$rptInfo+FJ_AddTagToReport(":K02:"; FJ_MaxString([eWires:13]BeneficiaryCompanyName:92+" "+[eWires:13]BeneficiaryAddress:59; 35; 4); True:C214)
		Else 
			$rptInfo:=$rptInfo+FJ_AddTagToReport(":K02:"; FJ_MaxString([eWires:13]BeneficiaryFullName:5+" "+[eWires:13]BeneficiaryAddress:59; 35; 4); True:C214)
		End if 
