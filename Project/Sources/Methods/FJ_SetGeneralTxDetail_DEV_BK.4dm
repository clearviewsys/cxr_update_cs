...
If ([eWires:13]RegisterID:24#"")
	...
	$rptInfo:=$rptInfo+"=N04:"+FJ_GetValue(String:C10($reg.Credit; "#########0.00"); "Foreign Currency Value")+CRLF
	
Else 
	$rptInfo:=$rptInfo+"=N01:"+FJ_GetValue([Registers:10]Currency:19; "Foreign Currency Code")+CRLF
	If ([Invoices:5]fromCurrency:3=[Registers:10]Currency:19)
		$rptInfo:=$rptInfo+"=N04:"+FJ_GetValue(String:C10(0; "#########0.00"); "Foreign Currency Value")+CRLF
	Else 
		$rptInfo:=$rptInfo+"=N04:"+FJ_GetValue(String:C10([Registers:10]Debit:8; "#########0.00"); "Foreign Currency Value")+CRLF
	End if 
...
If (False:C215)
	If ([Customers:3]Address:7#"")
		...
		$rptInfo:=$rptInfo+FJ_AddTagToReport(":P28:"; FJ_MaxString($address; 35; 4); True:C214)
	End if 
End if 
