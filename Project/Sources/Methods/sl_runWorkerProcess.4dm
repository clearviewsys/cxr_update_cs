...
$searchListParam : Collection; $logIdParam : Object; \
$optionsParam : cs:C1710.SanctionScreeningOptions)
var $signal : Object
var $name : Text
var $isEntity : Boolean
var $searchList; $results : Collection
var $logId : Object
...
$results:=sl_screenWithSanctionListCol($name; $isEntity; $searchList; $logId; $options)
$signal.trigger()
