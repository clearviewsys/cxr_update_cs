//%attributes = {}
// getAgentPendingAccountID (agentID; isPayable;currency)
...
QUERY:C277([Accounts:9]; [Accounts:9]isPendingAccount:24=True:C214; *)  // this is changed in version 3.452 - used to look for account payable
