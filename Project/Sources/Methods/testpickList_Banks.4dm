...
C_TEXT:C284($picked)
// [List_Banks];"Pick"
myAlert("The next step opens a picker for banks")
pickBankName(->$picked; True:C214)

pickBankName(->$picked)  // should not open the dialog


myAlert($picked)  // displays the pick
pickBankName(->$picked; True:C214)  // should open the dialog with a default picked
myAlert($picked)  // displays the pick
