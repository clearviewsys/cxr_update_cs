...
setKeyValue("CAB")
If (getKeyValue("CAB")="true")  //CAB
	setKeyValue("CAB.testMode")
	setKeyValue("CAB.useVPN")
	setKeyValue("CAB.extension")
	setKeyValue("CAB-extension")
	setKeyValue("CAB.customer.new.approvalstatus")
	setKeyValue("CAB.str.footermsg")
	setKeyValue("CAB.ws.url")
	setKeyValue("CAB.ws.user")
	setKeyValue("CAB.transaction.progress.show")
End if 
...
setKeyValue("invoices.customerid.reassign.allow")
setKeyValue("invoice.date.allowedit")
setKeyValue("invoice.number.autocorrect")

setKeyValue("registers.search.invoicedate")
setKeyValue("registers.valuedate.match.invoice")

setKeyValue("rdc.print.redirect")

If (False:C215)  //this is for MoneyWay
	keyValue__defaultsCentral1
End if 
...
If (True:C214)  // ----------- EWIRE DEFAULTS -------------
	...
	setKeyValue("ewire.accountid.useSelect")
End if 
...
If (True:C214)  // ---- EMAIL TEMPLATE CONFIG ---
	...
	setKeyValue("email.greetings.birthday.force.optin")
	setKeyValue("email.greetings.birthday.subject")
	setKeyValue("email.greetings.birthday.production.mode")
End if 
...
If (True:C214)  //init keyvalues so end user can change
	...
	setKeyValue("web.configuration.rates.source")
	
	setKeyValue("web.configuration.uselocalcdn")
	setKeyValue("web.configuration.dropzone.version")
	...
	If (True:C214)
		...
		setKeyValue("web.configuration.payments.square.test.user")
	...
	If (True:C214)  // --- CUSTOMER PORTAL CONFIG -----
		...
		setKeyValue("web.customers.module.quotes.show.rateinfo")
		setKeyValue("web.customers.module.quotes.useCustomerCountry")
		...
		setKeyValue("web.customers.profile.id.1.code")  //;"F;B;A;1;D")
		setKeyValue("web.customers.profile.id.1.help")
		setKeyValue("web.customers.profile.id.1.label")
		//setKeyValue ("web.customers.profile.id.1.id.mandatory")
		setKeyValue("web.customers.profile.id.2.code")  //;"1;D;")
		setKeyValue("web.customers.profile.id.2.required")
		setKeyValue("web.customers.profile.id.2.help")
		setKeyValue("web.customers.profile.id.2.label")
		//setKeyValue ("web.customers.profile.id.2.id.mandatory")
		setKeyValue("web.customers.profile.id.3.code")  //;"G")
		setKeyValue("web.customers.profile.id.3.required")
		setKeyValue("web.customers.profile.id.3.help")
		setKeyValue("web.customers.profile.id.3.label")
		setKeyValue("web.customers.profile.id.mandatory.code")
		setKeyValue("web.customers.profile.id.90dayexpire.code")
		setKeyValue("web.customers.profile.id.expiredate.max")
		setKeyValue("web.customers.profile.id.page2.required")  //id codes tthat require a page 2
