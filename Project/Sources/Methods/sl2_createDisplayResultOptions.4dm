...
#todo change $selectionParam to collection
#author @Wai-Kin
*/
...
For each ($entity; $selection) While ($loadListContinue)
	If (sl_getSanctionSourceForRecord($entity)=sl_useCXBlackListJSON)
		...
		If ($entity.ResponseJSON#Null:C1517)
			...
			Case of 
				...
				Else   // ($entity.CheckResult=?)
					...
					$form.resultStatus:=slOld_updateDisplayingLogStatus($form.resultStatus; $entity.CheckResult)
