...
Case of 
	: ($iProcess=0)  //doesn't exist so start it up
		$processSize:=Num:C11(getKeyValue("CalendarEvents.processSize"; "0"))
		$iProcess:=New process:C317(Current method name:C684; $processSize; $processName; True:C214; *)
	...
	: (Count parameters:C259=1)  //this is a new process so init
		...
		$iWakeInterval:=Num:C11(getKeyValue("CalendarEvents.wakeInterval"; "3600"))  //about every 1 minutes
