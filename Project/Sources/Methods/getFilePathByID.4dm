//%attributes = {}
//getFilePathByID (filepathID;machinename): filepath
...
C_TEXT:C284($filePathID; $filePath; $machineName; $0; $1; $2)
...
If (Records in selection:C76([FilePaths:83])>=1)
	...
	$filePath:=[FilePaths:83]FolderPath:3+[FilePaths:83]FileName:2
Else 
