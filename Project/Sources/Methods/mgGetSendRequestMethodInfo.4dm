...
If ($deliveryOption.TransferToPointId#Null:C1517)
	If ($deliveryOption.TransferToPointId#"")
		$getMethodInfoParams.TransferToPointId:=$deliveryOption.TransferToPointId
	End if 
End if 
...
//If ($logmgSOAP)
//mgLOG ("SendRequestMethodInfo returned "+JSON Stringify($0;*))
//End if 
