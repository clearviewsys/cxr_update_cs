...
USE SET:C118("eft")
//ORDER BY([eWires];[eWires]SendDate;>)
...
While (Not:C34(End selection:C36([eWires:13])))
	...
	If (Not:C34([Invoices:5]isAMLReported:45))
		...
		Else 
			...
			If (([eWires:13]Currency:12="TOM") | ([eWires:13]Currency:12="IRR") | ([eWires:13]fromCountryCode:111="IR") | ([eWires:13]toCountryCode:112="IR") | ([Customers:3]CountryCode:113="IR") | ([Links:17]countryCode:50="IR"))
...
ORDER BY:C49([eWires:13]; [Invoices:5]invoiceDate:44; >)
