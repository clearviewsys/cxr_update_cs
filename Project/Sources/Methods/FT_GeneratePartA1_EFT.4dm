...
// TODO:JA: Do not activate until testing



If ([eWires:13]isPaymentSent:20)
	If (getKeyValue("FT.Report.EFT.inCAD"; "no")="no")
		FT_partA_EFT($fileName; $partId; $repSeqNum; $repEntityRefNum; $actionCode; [eWires:13]creationTime:54; [eWires:13]creationDate:53; [eWires:13]ToAmount:14; $rule24Indicator; [eWires:13]Currency:12; [eWires:13]sourceRate:41)
	Else 
		FT_partA_EFT($fileName; $partId; $repSeqNum; $repEntityRefNum; $actionCode; [eWires:13]creationTime:54; [eWires:13]creationDate:53; [Registers:10]DebitLocal:23; $rule24Indicator; [Registers:10]baseCURR:60; [Registers:10]OurRate:25)
	End if 
