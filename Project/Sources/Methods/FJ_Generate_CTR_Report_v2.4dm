//%attributes = {}
// ------------------------------------------------------------------------------
// Method: FJ_Generate_CTR_Report_v2
...
For ($i; 1; $maxTx)
	...
	While (Not:C34(End selection:C36([Registers:10])))
		...
		// Report Transaction if it is a Cash Transactionn over 5K
		// [ServerPrefs]twoIDsLimit server preference must be 5000
		...
		If (FJ_IsCashOver(<>twoIDsLimit))
			...
			FJ_SetGeneralTxDetail_V2($fileName; [Invoices:5]fromAmountLC:38; [Invoices:5]CreationDate:13; [Invoices:5]fromAmountLC:38)
