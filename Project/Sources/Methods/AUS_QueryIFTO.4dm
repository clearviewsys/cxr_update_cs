...
$countryCode:=keyValue_getValue("AML.Reporting.CountryCode"; "AU")

QUERY SELECTION:C341([eWires:13]; [eWires:13]fromCountryCode:111=$countryCode; *)  // IFT (from AU to other country)
