...
Case of 
						...
						If ($state.result[0].TransferState#Null:C1517)
							...
							If ($found#Null:C1517)
								If ($found.length>0)
									...
									// refresh display in a form
									Form:C1466.paymentInfo.statusCheck:=[WebEWires:149]paymentInfo:35.statusCheck
								End if 
							End if 
						End if 
					End if 
	...
	: (Form event code:C388=On Load:K2:1)
		...
		OBJECT SET ENABLED:C1123(*; "b_checkMGStatus@"; True:C214)
		
		If ([WebEWires:149]paymentInfo:35.origin#Null:C1517)
			
			If ([WebEWires:149]paymentInfo:35.origin="SOAP")
				//OBJECT SET VISIBLE(*;"b_checkMGStatus@";False)
				OBJECT SET ENABLED:C1123(*; "b_checkMGStatus@"; False:C215)
			Else 
