...
If (Num:C11($auEnabled)=1)
	...
	// ----------------------------------------------------------------------------
	$downloadFolder:=getKeyValue("au.download.path"; System folder:C487(Desktop:K41:16)+"CXR_NewRelease"+Folder separator:K24:12)
...
Else 
	UTIL_Log("AutomaticUpdates"; "Updates are not enabled, please enable it on CXR_settings.xml file")
End if 
