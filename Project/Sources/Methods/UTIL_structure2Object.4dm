					...
					For ($vl_attrIndex; 1; DOM Count XML attributes:C727($vt_tableElementDomRef))
						...
						Case of 
							...
							: (($vt_attrValue="true") | ($vt_attrValue="false"))  // "prevent_journaling", "leave_tag_on_delete"
								OB SET:C1220($vo_table; UTIL_lowerCamelCase($vt_attrName); $vt_attrValue="true")
								
							Else 
								OB SET:C1220($vo_table; UTIL_lowerCamelCase($vt_attrName); $vt_attrValue)
						End case 
					End for 
				End if 
					...
					If (ok=1)
						...
						For ($vl_primaryKeyIndex; 1; $vl_nbPrimaryKey)
							...
							For ($vl_attrIndex; 1; DOM Count XML attributes:C727($vt_primaryKeyDomRef))
								...
								OB SET:C1220($vo_primaryKey; UTIL_lowerCamelCase($vt_attrName); $vt_attrValue)
							End for 
								...
								For ($vl_attrIndex; 1; DOM Count XML attributes:C727($vt_fieldElementDomRef))
									...
									Case of 
										...
										: ($vt_attrName="text_switch_size") | ($vt_attrName="blob_switch_size")
											OB SET:C1220($vo_field; UTIL_lowerCamelCase($vt_attrName); Num:C11($vt_attrValue))
											
										: (($vt_attrValue="true") | ($vt_attrValue="false"))  // "prevent_journaling", "leave_tag_on_delete"
											OB SET:C1220($vo_field; UTIL_lowerCamelCase($vt_attrName); $vt_attrValue="true")
											
										Else 
											OB SET:C1220($vo_field; UTIL_lowerCamelCase($vt_attrName); $vt_attrValue)
									End case 
								End for 
							End if 
				...
				For ($vl_attrIndex; 1; DOM Count XML attributes:C727($vt_relationDomRef))
					...
					Case of 
						...
						: (($vt_attrName="auto_load_Nto1") | ($vt_attrName="auto_load_1toN") | ($vt_attrName="foreign_key"))
							OB SET:C1220($vo_relation; UTIL_lowerCamelCase($vt_attrName); $vt_attrValue="true")
						...
						Else 
							OB SET:C1220($vo_relation; UTIL_lowerCamelCase($vt_attrName); $vt_attrValue)
					End case 
				End for 
			...
			For ($vl_indexIndex; 1; Size of array:C274($tt_indexElementDomRef))
				...
				For ($vl_attrIndex; 1; DOM Count XML attributes:C727($vt_indexDomRef))
					...
					Case of 
						...
						Else 
							OB SET:C1220($vo_index; UTIL_lowerCamelCase($vt_attrName); $vt_attrValue)
					End case 
				End for 
		...
		If (ok=1)
				...
				For ($vl_attrIndex; 1; DOM Count XML attributes:C727($vt_baseExtraDomRef))
					...
					Case of 
						: (($vt_attrName="resman_stamp") | \
							...
							OB SET:C1220($vo_extra; UTIL_lowerCamelCase($vt_attrName); Num:C11($vt_attrValue))
						...
						: (($vt_attrName="is_compiled_database") | \
							...
							OB SET:C1220($vo_extra; UTIL_lowerCamelCase($vt_attrName); $vt_attrValue="true")
							
						Else 
							OB SET:C1220($vo_extra; UTIL_lowerCamelCase($vt_attrName); $vt_attrValue)
					End case 
				End for 
			...
			If (True:C214)  // read the temp file properties
				...
				For ($vl_attrIndex; 1; DOM Count XML attributes:C727($vt_tempFolderDomRef))
					...
					OB SET:C1220($vo_tempFolder; UTIL_lowerCamelCase($vt_attrName); $vt_attrValue)
				End for 
			...
			If (True:C214)  // read the journal file properties
				...
				For ($vl_attrIndex; 1; DOM Count XML attributes:C727($vt_journalFileDomRef))
					...
					Case of 
						...
						Else 
							OB SET:C1220($vo_journal; UTIL_lowerCamelCase($vt_attrName); $vt_attrValue)
