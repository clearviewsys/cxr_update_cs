//%attributes = {}
// ------------------------------------------------------------------------------
// Method: FT_EFTI_report
// Generate the EFTI Report for FINTRAC
//
// Parameters: 
//
// Return:
...
FT_Get_EFTI_Transactions(initialDate)
...
If (Records in selection:C76([eWires:13])=0)
	$msg:="There are not transactions that can be reported as EFTI in the date requested"
	
	checkAddError($msg)
End if 

If (isValidationConfirmed)
	FT_GenerateEFTIReport($fileName)
