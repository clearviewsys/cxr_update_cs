...
$0:=False:C215
$isIranRelated:=([eWires:13]fromCountryCode:111="IR") | ([eWires:13]toCountryCode:112="IR")
...
If ([Invoices:5]invoiceDate:44=$refDate)
	...
	While (Not:C34(End selection:C36([Registers:10])))
		...
		If (([Registers:10]Currency:19="TOM") | ([Registers:10]Currency:19="IRR") | ([eWires:13]fromCountryCode:111="IR") | ([eWires:13]toCountryCode:112="IR"))
