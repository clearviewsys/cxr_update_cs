...
HandleEntryFormMethod(->[Links:17]; ->[Links:17]BranchID:38; ->[Links:17]createdByUser:39; ->[Links:17]modifiedByUser:40)
...
If (Form event code:C388=On Load:K2:1)
	...
	If (Is new record:C668([Links:17]))
		...
		If (Undefined:C82(theCustomerID))  // @milan to fix eWire issue for Lotus
			theCustomerID:=""
		End if 
		//If (getNextCustomer#getWalkInCustomerID)
		//vCustomerID:=getNextCustomer
		//OBJECT SET ENTERABLE([Links]CustomerID; False)
		//Else 
		//vCustomerID:=""
		//OBJECT SET ENTERABLE([Links]CustomerID; True)
		//End if 
...
End if 
stampText("stamp_self"; "Same as Customer"; "blue"; [Links:17]isCustomer:63)
