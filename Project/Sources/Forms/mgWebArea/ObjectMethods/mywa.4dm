			...
			: ($url=$url2)  // URL is appended with some values
				...
				If (Form:C1466.winref#Null:C1517)
					If (Form:C1466.valueObject#Null:C1517)
						...
						If (Form:C1466.WebewireID#Null:C1517)  // Lotus had two receive Webewires created in one branch
							...
							If (Form:C1466.WebewireID#"")
								...
								If ($invoiceOK.success)
									myAlert("Invoice number "+$invoiceOK.InvoiceID+" reserved for MoneyGram transaction number "+Form:C1466.WebewireID)
								Else 
